...
import Car from '../assets/images/carmain.jpg';
...
const About = () => {
    ...
    const getTopSeller = async () => {
      try {
        const res = await axios.get(
          'http://localhost:8000/api/sellers/topseller',
        );
  ...
  return (
    <main className='about'>
      <Helmet>
        <title>Listing App - About</title>
        <meta name='description' content='About us' />
      </Helmet>
      <header className='about__header'>
        <h1 className='about__heading'>About Listing App</h1>
      </header>
      <section className='about__info'>
        <div className='row'>
          <div className='col-3-of-4'>
            <h2 className='about__subheading'>
              We connect you to the perfect buyer or seller
            </h2>
            ...
            <div className='about__display'>
              <img className='about__display__image' src={Car} alt='' />
            </div>
            <p className='about__paragraph'>
